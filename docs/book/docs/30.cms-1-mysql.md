...
<pre><code class="lang-sql">SELECT STR_TO_DATE(&apos;2018-09-09&apos;,&apos;%Y-%m-%d&apos;)
</code></pre>
<table>
<thead>
<tr>
...
<pre><code class="lang-sql">SELECT IF(1&gt;0,&apos;A&apos;,&apos;B&apos;);
</code></pre>
...
<pre><code class="lang-sql">update student set email = UPPER(email)
</code></pre>
...
<pre><code class="lang-sql">select SUBSTR(level,1,1),SUBSTR(level,3,1) from user
order by 
...
<pre><code class="lang-sql">select SUBSTR(email FROM INSTR(email,&apos;@&apos;)+1) from student
WHERE ID = 3;
</code></pre>
...
<pre><code class="lang-sql">CREATE FUNCTION func_name RETURNS  {String|Integer}
body
</code></pre>
<h4 id="t1209.11.2 &#x5B9E;&#x4F8B;">9.11.2 &#x5B9E;&#x4F8B; <a href="#t1209.11.2 &#x5B9E;&#x4F8B;"> # </a></h4>
<pre><code class="lang-sql">CREATE FUNCTION znow() RETURNS VARCHAR(30)
RETURN DATE_FORMAT(NOW(),&apos;%Y&#x5E74;%m&#x6708;%d&#x65E5; %H&#x70B9;:%i&#x5206;%s&#x79D2;&apos;);
</code></pre>
<pre><code class="lang-sql">CREATE FUNCTION zadd(num1 INT,num2 INT) RETURNS INT
RETURN num1+num2;
</code></pre>
<pre><code class="lang-sql">CREATE TABLE stu(id int PRIMARY KEY AUTO_INCREMENT,name VARCHAR(50));
...
<pre><code class="lang-sql">select * from score where grade between 80 and 100
</code></pre>
<h4 id="t1249.12.3  IN">9.12.3  IN <a href="#t1249.12.3  IN"> # </a></h4>
<p>&#x67E5;&#x8BE2;&#x67D0;&#x4E00;&#x5217;&#x4E2D;&#x7684;&#x503C;&#x5728;&#x5217;&#x51FA;&#x7684;&#x5185;&#x5BB9;&#x5217;&#x8868;&#x4E2D;</p>
<pre><code class="lang-sql">select * from student where city in (&apos;&#x5317;&#x4EAC;&apos;,&apos;&#x4E0A;&#x6D77;&apos;,&apos;&#x5E7F;&#x4E1C;&apos;)
</code></pre>
